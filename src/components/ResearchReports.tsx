...
// Brokerage / research reports — full-width section below the bento.
// Flat table: company · action · target · broker · date · report link.
      ...
      <div className={css(styles, "reports-table")} role="table">
        ...
        {RESEARCH_REPORTS.map((report) => (
          <div key={report.id} className={css(styles, "reports-row")} role="row">
            ...
            <span className={css(styles, "reports-date")}>{report.date}</span>
